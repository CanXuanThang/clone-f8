...
const DateTimePickerBase = (props: Props) => {
    const { error, selectedDate, onChange, onBlur, ...rest } = props;
    ...
    return (
        <Box
            ...
            <DatePicker
                ...
                renderCustomHeader={({ changeYear, decreaseMonth, increaseMonth, monthDate }: any) => (
                    <div
                        style={{
                            display: 'flex',
                        ...
                        <Box sx={{ position: 'relative', display: 'flex', flexDirection: 'column' }}>
                            ...
                            <Button
                                sx={{ maxWidth: '16px', minWidth: '16px', margin: 'auto', padding: '0', color: '#7b8287' }}>
                                ...
                                {years.map((option) => (
                                    <MenuItem
                                        ...
                                        {String(option) ===
                                            ...
                                            <DoneIcon
                                                sx={{ height: '15px', width: '15px', position: 'absolute', left: '15px' }}
                                            />
                                        )}
                                        <span>{option}</span>
                                    </MenuItem>
